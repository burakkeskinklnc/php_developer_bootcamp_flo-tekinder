            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">İlan Düzenleme Sayfası</h1>
                    </div>

                    <?php foreach ($emlak as $emlakVeri) { ?>
                        <div class="col-xl-12 col-lg-12 col-md-9">
                            <form class="user" name="ilanGuncelle" onSubmit="return false;" enctype="multipart/form-data">
                                <div class="card o-hidden border-0 shadow-lg my-5">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">İlanı Düzenle</h1>
                                        </div>
                                        <div class="row mb-5">
                                            <div class="col-md-4">
                                                <img src="<?php echo $emlakVeri['resim1']; ?>" style="width:100%;display:block;" alt="">
                                            </div>
                                            <div class="col-md-4">
                                                <img src="<?php echo $emlakVeri['resim2']; ?>" style="width:100%;display:block;" alt="">
                                            </div>
                                            <div class="col-md-4">
                                                <img src="<?php echo $emlakVeri['resim3']; ?>" style="width:100%;display:block;" alt="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="card-body p-0 col-xl-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <input type="hidden" name="ilanId" value="<?php echo $emlakVeri['id']; ?>">
                                                        <div class="form-group">
                                                            <label for="ilanBaslik">İlan Başlığı</label>
                                                            <input type="text" class="form-control" name="ilanBaslik" id="ilanBaslik" value="<?php echo $emlakVeri['ilanBaslik']; ?>" placeholder="">
                                                        </div>
                                                        <input type="hidden" name="olusturmaTarihi" value="<?php echo date('Y-m-d'); ?>">
                                                        <div class="form-group">
                                                            <label for="aciklama">İlan Açıklama</label>
                                                            <textarea style="resize: none;" rows="13" cols="20" class="form-control" id="aciklama" name="aciklama" placeholder="İlan Açıklamasını buraya yazınız.." minlength="10" maxlength="300"><?php echo $emlakVeri['ilanAciklama']; ?></textarea>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 ">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" class="form-control" id="emlakFiyat" name="emlakFiyat" required value="<?php echo $emlakVeri['emlakFiyat']; ?>" placeholder="Emlak Fiyat Bilgisini buraya yazınız..">
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 ">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" class="form-control" id="metrekare" name="metrekare" value="<?php echo $emlakVeri['metrekare']; ?>" required placeholder="Metrekare Bilgisini buraya yazınız..">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-6 ">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" class="form-control" id="binaYasi" name="binaYasi" value="<?php echo $emlakVeri['binaYasi']; ?>" placeholder="Bina Yaşı Bilgisini buraya yazınız..">
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 ">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" class="form-control" id="bulunduguKat" value="<?php echo $emlakVeri['bulunduguKat']; ?>" name="bulunduguKat" placeholder="Bulunduğu Kat Bilgisini buraya yazınız..">
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="card-body p-0 col-xl-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 mb-1">
                                                        <div class="form-group ml-3">
                                                            <button class="btn btn-warning" type="submit"><i class="fa fa-save"></i> Güncelle</button>
                                                        </div>
                                                    </div>
